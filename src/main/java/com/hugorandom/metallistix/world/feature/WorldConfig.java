...
public class WorldConfig {
    ...
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> DISPROSIO_ORE =
            FeatureUtils.register("disprosio_ore", Feature.ORE, new OreConfiguration(DISPROSIO_SPAWN, 6));
    ...
    public static final Holder<ConfiguredFeature<OreConfiguration, ?>> HALIX_ORE =
            FeatureUtils.register("halix_ore", Feature.ORE, new OreConfiguration(HALIX_SPAWN, 4));
