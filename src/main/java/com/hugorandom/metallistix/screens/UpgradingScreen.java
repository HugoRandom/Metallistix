...
public class UpgradingScreen extends AbstractContainerScreen<UpgradingMenu> {
    ...
    private static final ResourceLocation UPGRADING_SCREEN =
            new ResourceLocation(Metallistix.MOD_ID, "textures/gui/upgrading_gui.png");
    ...
    protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pMouseX, int pMouseY) {
        ...
        if(menu.isCrafting()){
            ...
            this.blit(pPoseStack, x + 125 - menu.getScaledProgress(), y + 35,
                    196 - menu.getScaledProgress(), 13, menu.getScaledProgress(), 13);
        }
    }
