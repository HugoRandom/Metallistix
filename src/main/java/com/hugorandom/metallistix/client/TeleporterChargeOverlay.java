...
public class TeleporterChargeOverlay {
    ...
    private static final ResourceLocation TELECHARGE_OFF = new ResourceLocation(Metallistix.MOD_ID,
            "textures/overlays/telecharge_off.png");
    private static final ResourceLocation TELECHARGE_ON = new ResourceLocation(Metallistix.MOD_ID,
