...
public class UpgradingCategory implements IRecipeCategory<UpgradingRecipe> {
    ...
    public final static ResourceLocation UID = new ResourceLocation(Metallistix.MOD_ID, "upgrading");
    public static ResourceLocation TEXTURE = new ResourceLocation(Metallistix.MOD_ID,
    ...
    public UpgradingCategory(IGuiHelper helper){
        ...
        this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK,
                new ItemStack(BlocksInit.METALLISTIX_BLOCK.get()));
    ...
    @Override
    public void draw(UpgradingRecipe recipe, IRecipeSlotsView recipeSlotsView, PoseStack stack,
