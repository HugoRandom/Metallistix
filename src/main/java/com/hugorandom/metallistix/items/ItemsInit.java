...
public class ItemsInit {
    ...
    // Lingotes - Ingots
    public static final RegistryObject<Item> DISPROSIO_INGOT = ITEMS.register("disprosio_ingot", CommonItem::new);
    ...
    public static final RegistryObject<Item> HALIX_INGOT = ITEMS.register("halix_ingot", CommonItem::new);
    public static final RegistryObject<Item> MIGUELITIO_INGOT = ITEMS.register("miguelitio_ingot", CommonItem::new);

    // Pepitas
    public static final RegistryObject<Item> DISPROSIO_NUGGET = ITEMS.register("disprosio_nugget", CommonItem::new);
    ...
    public static final RegistryObject<Item> HALIX_NUGGET = ITEMS.register("halix_nugget", CommonItem::new);
    ...
    public static final RegistryObject<Item> RAW_DISPROSIO = ITEMS.register("raw_disprosio", CommonItem::new);
    public static final RegistryObject<Item> RAW_FRANITOLINA = ITEMS.register("raw_franitolina", CommonItem::new);
    public static final RegistryObject<Item> RAW_MELUNA = ITEMS.register("raw_meluna", CommonItem::new);
    public static final RegistryObject<Item> RAW_ALEZARITA = ITEMS.register("raw_alezarita", CommonItem::new);
    public static final RegistryObject<Item> RAW_HALIX = ITEMS.register("raw_halix", CommonItem::new);
    public static final RegistryObject<Item> RAW_MIGUELITIO = ITEMS.register("raw_miguelitio", CommonItem::new);

    // Polvos No españoles
    public static final RegistryObject<Item> DISPROSIO_DUST = ITEMS.register("disprosio_dust", CommonItem::new);
    ...
    public static final RegistryObject<Item> HALIX_DUST = ITEMS.register("halix_dust", CommonItem::new);
    public static final RegistryObject<Item> MIGUELITIO_DUST = ITEMS.register("miguelitio_dust", CommonItem::new);

    // Gemas
    public static final RegistryObject<Item> DISPROSIO_GEM = ITEMS.register("disprosio_gem", GemItem::new);
    ...
    public static final RegistryObject<Item> HALIX_GEM = ITEMS.register("halix_gem", GemItem::new);
